...
def transform_point2d(tf_buffer, point, current_timestamp, current_frame, target_frame, lookup_timeout=0.2):
    ...
    return Point2D(target_pt.point.x, target_pt.point.y)
